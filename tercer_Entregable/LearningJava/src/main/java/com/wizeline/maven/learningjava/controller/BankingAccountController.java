...
public class BankingAccountController {
	...
	//definicion de atributos dentro de la misma clase
    @Value("${server.port}")
    private String port;
    ...
    //hacemos autowiring de KafkaTemplate
    @Autowired
    ...
    //snippet que es un endpoint que mandara el mensaje usando KafkaTemplate
   ...
   public ResponseEntity<List<BankAccountDTO>> getAccounts() {//uso de Ribbon, para el uso de load-balancing del lado del cliente.
